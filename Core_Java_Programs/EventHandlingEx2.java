/*2- create a ui to accept 2 no. and display the resut on button click.
...
public class EventHandlingEx2 extends Frame implements ActionListener {
    Button b, b1, b2,b3;
    Label l, l1, l2; //used for non editable text
    TextField t1, t2;

    EventHandlingEx2() {
        l = new Label("enter no 1");
    ...
    public static void main(String[] args) {
        EventHandlingEx2 e2 = new EventHandlingEx2();
    }
}